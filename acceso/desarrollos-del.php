...
<div align="center">
	...
	<div class="contenedor">
		<div class="cont-inf-mont" style="float:none;">
			<h2>Esta Desarrollo será ELIMINADO permanentemente</h2>
			<form action="desarrollos-delt.php" method="post" name="form1" id="form1" style="margin-left:0; width:900px;">
...
?>
				...
				<input type="submit" name="publicar" value="Eliminar" />
			</form><br /><br />
		</div>
	</div>
</div>
