...
<div align="center">
<?php
	//busqueda el titulo y el id de la articulos ya sea que den el ano o el mes o ambos por post
	include("bd/articulos-select-list.php");
?>
...
<?php 
	while ($fila = $resultado->fetch_array(MYSQLI_ASSOC)){
		echo '<option value="articulos-del.php?num='.$fila["id_articulos"].'">'.$fila["titulo"].'</option>"';
	}
?>                      
				</select>
			</form><br><br><br>
