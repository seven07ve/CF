...
//insertar
$isql=("INSERT INTO noticias (titulo,contenido,dia,mes,ano,autor) VALUES ('".addslashes($_POST['titulo'])."','".addslashes($_POST['elm1'])."','".$_POST["dia"]."','".$_POST["mes"]."','".$_POST["ano"]."','".$_POST["autor"]."')");
...
$ssql=sprintf("SELECT titulo,contenido,dia,mes,ano,autor,id_noticia FROM noticias WHERE id_noticia='".$id_noticia."'");
