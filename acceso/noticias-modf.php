...
//actualizar
$usql="UPDATE noticias SET titulo='".addslashes($_POST["titulo"])."', contenido='".addslashes($_POST["elm1"])."', dia='".$_POST["dia"]."', mes='".$_POST["mes"]."', ano='".$_POST["ano"]."', autor='".$_POST["autor"]."' WHERE id_noticia='".$_POST["id_noticia"]."'"; 
//ejecuta la sentencia sql
$actualizar = $mysqli->query($usql);

//busqueda de los datos de la noticia
$ssql=sprintf("SELECT titulo,contenido,dia,mes,ano,autor,id_noticia FROM noticias WHERE id_noticia='".$_POST["id_noticia"]."'");
//ejecuta la sentencia sql
...
?>
  ...
  <div class="contenedor">
      ...
      <input type="hidden" name="" />
        ...
        <br /><br />
        <a href="noticias-mod.php?num=<?php echo $id_noticia; ?>" style="color:#FFFFFF; text-decoration:none;" ><h2>Modificar</h2></a>
        <br />
        <label> Por<br />
