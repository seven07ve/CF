                    ...
                    <div class="row">
                        <div class="col-xs-11 col-sm-11 col-md-offset-1 col-md-11 text-justify text-med">
                            <img class="img-responsive pull-right  img-res-right" src="imagenes/valores.png"
                                  ...
                                  de las personas y de las instalaciones, a través de decisiones y acciones que
                                  aseguran el cumplimiento de la norma y de los principios de responsabilidad
                                  social y ética. <br><br>
                        </div>
                </div>
            </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-xs-11 col-sm-11 col-md-offset-1 col-md-11 text-justify text-med">
                            <img class="img-responsive pull-right img-res-right" src="imagenes/valores.png"
                                  ...
                                  respeto y aprendizaje colaborativo en un clima de confianza.
                                   <br><br>
                        </div>
                </div>
            </div>
           ...
           <?php $nosotros=active; include("php/menu.php"); ?>
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-offset-1 col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-xs-11 col-sm-11 col-md-offset-1 col-md-11 text-justify text-grd">
                            <img class="img-responsive" src="imagenes/esquema.png"
                                  style="margin:0 auto; border-radius:8px;" alt="ESQUEMA ORGANIZACIONAL" title="ESQUEMA ORGANIZACIONAL">
                        </div>
                    </div>
                </div>
            </div>
