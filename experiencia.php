            ...
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-offset-2 col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-xs-11 col-sm-11 col-md-offset-1 col-md-11 text-justify text-peq">
                            <ul style="margin-left:20px;">
                                <li><strong>CLIENTE</strong> AMEC FOSTER WHEELER MEXICO / PEMEX<br>
                                ...
                                <li><strong>CLIENTE</strong> WORLEYPARSONS COLOMBIA / PUERTO
                                BAHÍA<br>
                                ...
                                <li><strong>CLIENTE</strong> NAS COLOMBIA / ECOPETROL<br>
                                <strong>REFERENCIA</strong> Asistencia Técnica de Ingeniería en Campo,
                                Proyecto -City Gate nuevo en la Central Generadora de Termosuria. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li><br>
                                <li><strong>CLIENTE</strong> AMEC FOSTER WHEELER MEXICO / PEMEX<br>
                                <strong>REFERENCIA</strong> Asistencia Técnica en Flexibilidad y Soportería,
                                Oficinas de Monterrey, N.L. Proyecto IPC Planta Hidrodesulfuradora de Destilados
                                intermedios No. 4 “U-800-2”, así como la Integración y los Servicios Auxiliares fuera
                                del límite de batería (OSBL) de las Plantas, en la Refinería “Ing. Héctor R. Lara
                                Sosa”, Cadereyta, N.L. <br>
                                <strong>LUGAR</strong> México.
                                </li>
                                <li><strong>CLIENTE</strong> WORLEYPARSONS COLOMBIA /
                                PETROECUADOR<br>
                                <strong>REFERENCIA</strong> Levantamiento de Información en Campo y Diseño
                                Mecánico Proyecto “Reingeniería y Construcción de Sistemas de Drenajes de los
                                Efluentes líquidos de Refinería Esmeraldas”. <br>
            ...
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-offset-2 col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-xs-11 col-sm-11 col-md-offset-1 col-md-11 text-justify text-peq">
                            <ul style="margin-left:20px;">
                                <li><strong>CLIENTE</strong> INELECTRA INTERNACIONAL/ CHEVRON<br>
                                <strong>REFERENCIA</strong> Piping Dynamic Stress Analysis for Reciprocanting
                                Compresor Piping system, Ballena Compresion Project. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li><br>
                                <li><strong>CLIENTE</strong> NAS COLOMBIA / ECOPETROL<br>
                                <strong>REFERENCIA</strong> Ingeniería de Detalle –City Gate nuevo en la
                                Central Generadora de Termosuria. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li><br>
                                <li><strong>CLIENTE</strong> BOHORQUEZ INGENIERÍA/ CHEVRON<br>
                                <strong>REFERENCIA</strong> Análisis de Flexibilidad de Tubería, Sistema de
                                Compresión Proyecto “Gace Stage IV 100 psi Detail Engineering”.<br>
                                <strong>LUGAR</strong> Colombia.
                                </li>
                                <li><strong>CLIENTE</strong> BOHORQUEZ INGENIERÍA/ CHEVRON<br>
                                <strong>REFERENCIA</strong> Revisión Análisis de Flexibilidad de tubería, Sistema
                                Debottlenecking Proyecto “Gace Stage IV 100 psi Detail Engineering”. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li><br>
                                <li><strong>CLIENTE</strong> PACIFIC RUBIALES ENERGY (PRE)<br>
                                <strong>REFERENCIA</strong> Revisión Análisis por Golpe de ariete, Plataforma
                                múltiple de Inyección 3, Campo Quifa. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-offset-2 col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-xs-11 col-sm-11 col-md-offset-1 col-md-11 text-justify text-peq">
                            <ul style="margin-left:20px;">
                                <li><strong>CLIENTE</strong> PACIFIC RUBIALES ENERGY (PRE)<br>
                                <strong>REFERENCIA</strong> Revisión Ingeniería de Detalle para Instalación
                                SKID Antisurge en PAD-6, Campo Rubiales. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li><br>
                                <li><strong>CLIENTE</strong> BOHORQUEZ INGENIERÍA/ PACIFIC RUBIALES
                                ENERGY (PRE)<br>
                                <strong>REFERENCIA</strong> Análisis por Golpe de ariete, Sistema de Bombas de
                                Alta Presión, Proyecto “Optimización Equipos existentes Campo Sabanero”. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li><br>
                                <li><strong>CLIENTE</strong> PACIFIC RUBIALES ENERGY (PRE)<br>
                                <strong>REFERENCIA</strong> Análisis por Golpe de ariete, Plataformas múltiples
                                de Inyección 4 y 6, Campo Rubiales. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li>
                                <li><strong>CLIENTE</strong> PACIFIC RUBIALES ENERGY (PRE)<br>
                                <strong>REFERENCIA</strong> Ingeniería de Detalle para Instalación SKID
                                Antisurge en PAD-4, Campo Rubiales. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li><br>
                                <li><strong>CLIENTE</strong> Y&amp;V ING. Y CONSTRUCCIÓN/ PACIFIC RUBIALES ENERGY (PRE)<br>
                                <strong>REFERENCIA</strong> Análisis de Flexibilidad de tubería, Área nuevo
                                manifold e Intercambiadores CRU-VAP y CRU-CRU, Proyecto “Ingeniería Básica y
                                Detallada Mejora de Facilidades de Superficie – Campo Sabanero”. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-offset-2 col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-xs-11 col-sm-11 col-md-offset-1 col-md-11 text-justify text-peq">
                            <ul style="margin-left:20px;">
                                <li><strong>CLIENTE</strong> PACIFIC RUBIALES ENERGY (PRE)<br>
                                <strong>REFERENCIA</strong> Revisión del Sistema de protección por Golpe de
                                ariete, PAD-7 y PAD-9, Campo Rubiales. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li><br>
                                <li><strong>CLIENTE</strong> PANTHERS MACHINERY /ECOPETROL<br>
                                <strong>REFERENCIA</strong> Análisis Dinámico de Flexibilidad de tubería,
                                Sistema de Inyección de Agua Santos 37-5. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li><br>
                                <li><strong>CLIENTE</strong> MASA a STORK TECHNICAL SERVICES
                                COMPANY<br>
                                <strong>REFERENCIA</strong> Análisis de Flexibilidad de Tubería durante
                                izamiento para obras de mantenimiento. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li>
                                <li><strong>CLIENTE</strong> PUERTO BAHÍA a PACINFRA INFRASTRUCTURE Inc.
<br>
                                <strong>REFERENCIA</strong> Simulaciones de Procesos para determinación de
                                flujos y Composición de Vapores al Incinerador de Puerto Bahía. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li><br>
                                <li><strong>CLIENTE</strong> PUERTO BAHÍA a PACINFRA INFRASTRUCTURE Inc.
<br>
                                <strong>REFERENCIA</strong> Estudio de Opciones para manejo de Crudo Pesado
                                12°API y 4950 cSt por el Descargadero – Puerto Bahía. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-offset-2 col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-xs-11 col-sm-11 col-md-offset-1 col-md-11 text-justify text-peq">
                            <ul style="margin-left:20px;">
                                <li><strong>CLIENTE</strong> TIGER ENGINEERING / PUERTO BAHÍA<br>
                                <strong>REFERENCIA</strong> Análisis por Golpe de ariete en la línea de
                                transporte de crudo hacia Muelle Principal en Sociedad Portuaria Puerto Bahía
                                (SPPB).<br>
                                <strong>LUGAR</strong> Colombia.
                                </li><br>
                                <li><strong>CLIENTE</strong> PUERTO BAHÍA a PACINFRA INFRASTRUCTURE Inc.
<br>
                                <strong>REFERENCIA</strong> Estudio de Factibilidad para adecuación de tanque
                                de 340 MBls para manejo de Crudos Calientes. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li><br>
                                <li><strong>CLIENTE</strong> PUERTO BAHÍA a PACINFRA INFRASTRUCTURE Inc.
<br>
                                <strong>REFERENCIA</strong> Simulaciones de Proceso para determinación de
                                Flujos y Composición de Vapores al Incinerador de Puerto Bahía y Segregación de
                                corrientes – Actualización año 2015. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li>
                                <li><strong>CLIENTE</strong> INDUSTRIAL CONSULTING GROUP<br>
                                <strong>REFERENCIA</strong> Revisión de Ingeniería – Soporte Técnico en las
                                Actividades del Pliego de Licitación Oferta Gasoducto El Encino – La Laguna. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li><br>
                                <li><strong>CLIENTE</strong> PUERTO BAHÍA a PACINFRA INFRASTRUCTURE Inc.
<br>
                                <strong>REFERENCIA</strong> Estudio de Opciones para aumento de Capacidad
                                de Manejo de Crudo Pesado por el Descargadero – Puerto Bahía.<br>
                                <strong>LUGAR</strong> Colombia.
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-11 col-sm-11 col-md-offset-1 col-md-11 text-justify text-peq">
                            <ul style="margin-left:20px;">
                                <li><strong>CLIENTE</strong> PUERTO BAHÍA a PACINFRA INFRASTRUCTURE Inc.
<br>
                                <strong>REFERENCIA</strong> Estudio de Capacidad de Muelle de Barcazas para
                                manejo de Crudo Pesado 12.7°API – Sociedad Portuaria Puerto Bahía (SPPB).<br>
                                <strong>LUGAR</strong> Colombia.
                                </li><br>
                                <li><strong>CLIENTE</strong> CIMA TQ<br>
                                <strong>REFERENCIA</strong> Simulaciones de Proceso para determinación de
                                velocidades de líquido, gas y mezcla, patrón de flujo, slip liquid hold up, en
                                Oleoductos. <br>
                                <strong>LUGAR</strong> Colombia.
                                </li><br>
                            </ul>
